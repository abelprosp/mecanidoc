...
add column if not exists supplier_user_id uuid references public.users(id),
...
create policy "Authenticated users can read all promotions" on public.promotions for select to public using (true);
drop policy if exists "Authenticated users can insert promotions" on public.promotions;
create policy "Authenticated users can insert promotions" on public.promotions for insert to public with check (true);
drop policy if exists "Authenticated users can update promotions" on public.promotions;
create policy "Authenticated users can update promotions" on public.promotions for update to public using (true) with check (true);
drop policy if exists "Authenticated users can delete promotions" on public.promotions;
create policy "Authenticated users can delete promotions" on public.promotions for delete to public using (true);
...
-- -----------------------------------------------------------------------------
-- Détails commande (livraison, garantie) + lecture fournisseur
-- -----------------------------------------------------------------------------
alter table public.orders
