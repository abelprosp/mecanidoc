...
type HeroCamionProps = { category?: string };

export default function HeroCamion({ category = 'Camion' }: HeroCamionProps) {
          ...
          <div className="w-full max-w-3xl">
            ...
            <div className="flex flex-nowrap overflow-x-auto items-end pl-2 relative z-20 pb-1 scrollbar-hide w-full gap-[-1rem] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              ...
              <div className="flex-shrink-0 relative z-40 -mr-4">
                <Link href="/">
                  <div className="bg-[#E5E7EB] text-gray-600 px-3 py-2.5 md:px-10 md:py-3 rounded-t-md flex items-center gap-1.5 md:gap-2 font-medium transform skew-x-[20deg] shadow-[inset_0_-2px_4px_rgba(0,0,0,0.05)] border-r border-gray-300 min-h-[42px] md:min-h-0">
              ...
              <div className="flex-shrink-0 relative z-30 -mr-4">
               ...
               <div className="flex-shrink-0 relative z-50 -mr-4">
                <Link href="/camion">
                  <div className="bg-white text-gray-800 px-3 py-2.5 md:px-8 md:py-3 rounded-t-md flex items-center gap-1.5 md:gap-2 font-bold transform skew-x-[20deg] shadow-[2px_-2px_5px_rgba(0,0,0,0.1)] min-h-[42px] md:min-h-0">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1.5 md:gap-2">
