...
export default function BrandCarouselCamion() {
  const brands = [
    { 
      name: 'MICHELIN', 
    ...
    { 
      name: 'BRIDGESTONE', 
      logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Bridgestone-Logo.svg/320px-Bridgestone-Logo.svg.png',
      color: 'text-black' 
    },
    { 
      name: 'GOODYEAR', 
      logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Goodyear_Logo.svg/320px-Goodyear_Logo.svg.png',
      color: 'text-yellow-500' 
    },
    { 
      name: 'CONTINENTAL', 
      logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Continental_logo.svg/320px-Continental_logo.svg.png',
      color: 'text-orange-500' 
    },
    { 
      name: 'HANKOOK', 
      logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Hankook_Tire_logo.svg/320px-Hankook_Tire_logo.svg.png',
