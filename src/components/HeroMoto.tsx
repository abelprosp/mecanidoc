          ...
          <div className="w-full max-w-3xl">
            ...
            <div className="flex flex-nowrap overflow-x-auto items-end pl-2 relative z-20 pb-1 scrollbar-hide w-full gap-[-1rem] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              ...
              <div className="flex-shrink-0 relative z-50 -mr-4">
                <Link href="/moto">
                  <div className="bg-white text-gray-800 px-8 py-3 rounded-t-md flex items-center gap-1 md:gap-2 font-bold transform skew-x-[20deg] shadow-[2px_-2px_5px_rgba(0,0,0,0.1)]">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1 md:gap-2">
               ...
               <div className="flex-shrink-0 relative z-20 -mr-4">
                <Link href="/camion">
                  <div className="bg-[#E5E7EB] text-gray-600 px-8 py-3 rounded-t-md flex items-center gap-1 md:gap-2 font-medium transform skew-x-[20deg] hover:bg-gray-300 transition-colors cursor-pointer border-r border-gray-300 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.05)]">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1 md:gap-2">
              ...
              <div className="flex-shrink-0 relative z-10">
                <Link href="/tracteurs">
                  <div className="bg-[#E5E7EB] text-gray-600 px-8 py-3 rounded-t-md flex items-center gap-1 md:gap-2 font-medium transform skew-x-[20deg] hover:bg-gray-300 transition-colors cursor-pointer shadow-[inset_0_-2px_4px_rgba(0,0,0,0.05)]">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1 md:gap-2">
            ...
            <div className="bg-white rounded-b-xl rounded-tr-xl shadow-2xl p-4 md:p-6 text-gray-800 relative z-30 mt-[-1px]">
              ...
              <div className="border border-gray-100 rounded-xl p-4 md:p-6">
                ...
                {/* Dropdowns Grid - Moto Specific if needed, usually Width/Height/Rim/Load/Speed too */}
