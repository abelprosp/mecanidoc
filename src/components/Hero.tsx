...
type HeroProps = { category?: string };
    ...
    <div className="layout-container py-3 md:py-5">
      <div className="relative bg-gray-900 h-auto md:h-[550px] md:rounded-[2.5rem] flex flex-col items-center justify-center text-white overflow-hidden shadow-2xl py-8 md:py-0 px-3 sm:px-4 md:px-6">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="https://images.unsplash.com/photo-1487754180451-c456f719a1fc?q=80&w=2072&auto=format&fit=crop" 
          ...
          <div className="w-full max-w-3xl">
            ...
            <div className="flex flex-nowrap overflow-x-auto items-end pl-2 relative z-20 pb-1 scrollbar-hide w-full gap-[-1rem] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              ...
              <div className="flex-shrink-0 relative z-40 -mr-4">
                <Link href="/">
                  <div className="bg-white text-gray-800 px-3 py-2.5 md:px-10 md:py-3 rounded-t-md flex items-center gap-1.5 md:gap-2 font-bold transform skew-x-[20deg] shadow-[2px_-2px_5px_rgba(0,0,0,0.1)] min-h-[42px] md:min-h-0">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1.5 md:gap-2">
                      <Car className="w-4 h-4 md:w-5 md:h-5" />
                      <span className="text-xs md:text-base">Auto</span>
                    </div>
                  </div>
                </Link>
              </div>
              ...
              <div className="flex-shrink-0 relative z-30 -mr-4">
                <Link href="/moto">
                  <div className="bg-[#E5E7EB] text-gray-600 px-3 py-2.5 md:px-8 md:py-3 rounded-t-md flex items-center gap-1.5 md:gap-2 font-medium transform skew-x-[20deg] hover:bg-gray-300 transition-colors cursor-pointer border-r border-gray-300 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.05)] min-h-[42px] md:min-h-0">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1.5 md:gap-2">
                      <Bike className="w-4 h-4 md:w-5 md:h-5" />
                      <span className="text-xs md:text-base">Moto</span>
                    </div>
                  </div>
                </Link>
              </div>
                ...
                <Link href="/camion">
                  <div className="bg-[#E5E7EB] text-gray-600 px-3 py-2.5 md:px-8 md:py-3 rounded-t-md flex items-center gap-1.5 md:gap-2 font-medium transform skew-x-[20deg] hover:bg-gray-300 transition-colors cursor-pointer border-r border-gray-300 shadow-[inset_0_-2px_4px_rgba(0,0,0,0.05)] min-h-[42px] md:min-h-0">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1.5 md:gap-2">
                      ...
                      <span className="text-xs md:text-base">Camion</span>
                    </div>
                  </div>
                </Link>
              </div>
              ...
              <div className="flex-shrink-0 relative z-10">
                <Link href="/tracteurs">
                  <div className="bg-[#E5E7EB] text-gray-600 px-3 py-2.5 md:px-8 md:py-3 rounded-t-md flex items-center gap-1.5 md:gap-2 font-medium transform skew-x-[20deg] hover:bg-gray-300 transition-colors cursor-pointer shadow-[inset_0_-2px_4px_rgba(0,0,0,0.05)] min-h-[42px] md:min-h-0">
                    <div className="transform -skew-x-[20deg] flex items-center gap-1.5 md:gap-2">
                      <Tractor className="w-4 h-4 md:w-5 md:h-5" />
                      <span className="text-xs md:text-base">Tracteurs</span>
                    </div>
                  </div>
                </Link>
              </div>
            ...
            {/* Main Form Area */}
            <div className="bg-white rounded-b-xl rounded-tr-xl shadow-2xl p-4 md:p-6 text-gray-800 relative z-10 mt-[-1px]">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        disabled={!selected.diameter} // Can be selected without load sometimes, but let's keep consistency
