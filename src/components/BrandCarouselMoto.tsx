...
export default function BrandCarouselMoto() {
  const brands = [
    { 
      name: 'MICHELIN', 
    ...
    { 
      name: 'PIRELLI', 
      logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Pirelli_logo.svg/320px-Pirelli_logo.svg.png',
      color: 'text-red-600' 
    },
    { 
      name: 'METZELER', 
      logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Metzeler_logo.svg/320px-Metzeler_logo.svg.png',
      color: 'text-blue-500' 
    },
    { 
      name: 'BRIDGESTONE', 
    ...
    { 
      name: 'DUNLOP', 
      logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Dunlop_Tires_logo.svg/320px-Dunlop_Tires_logo.svg.png',
      color: 'text-black' 
    },
  ];
